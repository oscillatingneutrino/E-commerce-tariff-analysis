...
Data from TEMU's profits up to the 2nd quarter of 2025 have been made available, and thus data from 2023 Q1 to 2025 Q2 is used. As such, the effect of tariffs only up to June 30th is used. Following is a simple timeline of tariffs passed relevant to e-commerce from China following the election of Donald Trump.
...
In contrast, the QOQ initially also gives the notion that tariffs are responsible for a decrease in quarter on quarter growth, but an important pattern emerges: growth decreases during the transition between the last year's fourth quarter, and the next year's first quarter, before rebounding during the second quarter, decreasing during the 3rd quarter, and then returning to a high peak in the fourth quarter. This trend seems to instead imply that QOQ behavior is substantially influenced by consumer spending habits, rather than external factors. One should note that the fourth quarter encapsulates the holidays, the time during which clients are more inclined to spend on gifts. The quarter after would then reflect the time during which consumers are less incentivised to spend, a behavior that begins to end by the time the second quarter rolls around. That being said, there is a visible decrease in the absolute QOQ value during the beginning of tariffs relative to other years, which indicates the overall decrease in the amount that individuals are willing to spend on products from TEMU, which is likely a result of tariffs.
...
In the graphic above, the operating margin and the gross margin are compared throughout the set of quarter ranges. Looking at the operating margin one can note the comparatively smaller numbers per quarter. Generally speaking, the margin continues rising until after the 2nd quarter of 2024, at which point it continues to decrease, reaching a low during Q1 of 2025, and returning to margins comparable to previous quarters during Q2 of 2025. That being said, however, after the major drop from Q1 2024 to Q2 2024, the margin stays more or less within the same range of all values; the only other major reduction in margin occured during the first quarter of 2025, when the tariff war between the United States and China had begun. Once more, during the second quarter, when tariffs began to relax, the operating margin returned to a more common value.
